...
const BannerCard = ({ imageUrl, categoryName }, index) => {    
  return (
    <div
      key={index}
      className="w-280 h-200 bg-gradient-to-r from-cyan-500 to-violet-700 rounded-lg shadow-lg flex flex-column items-center justify-around text-white font-semibold text-xl p-4"
    >
